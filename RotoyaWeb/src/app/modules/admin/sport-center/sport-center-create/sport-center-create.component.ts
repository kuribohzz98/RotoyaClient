...
import { convertTimeToNumber } from '../../../../helper/util/time';
...
export class SportCenterCreateComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    onSubmit(): void {
        ...
        sportCenterData.timeOpen = convertTimeToNumber(this.formStep2.value.timeOpen);
        sportCenterData.timeClose = convertTimeToNumber(this.formStep2.value.timeClose);
